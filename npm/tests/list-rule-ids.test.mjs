...
/**
 * Створює тимчасове дерево rules/ з main.mjs і прихованими каталогами.
...
function makeFakeRules({ withFix = [], withoutFix = [], hidden = [] }) {
  ...
  for (const id of withFix) {
    ...
    writeFileSync(join(root, id, 'main.mjs'), '')
  }
