...
4.  **Завантаження ігнорування:** Завантажує список абсолютних шляхів, які слід ігнорувати, з конфігурації `.n-rules.json:ignore`.
...
- **Ігнорування:** Підтримується ігнорування файлів за допомогою `.n-rules.json:ignore` та кешування шляхів ігнорування у `walkCache`.
