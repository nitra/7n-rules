...
5. Застосування T0-патерну генерує змінені файли. Ці зміни фіксуються через механізм `recordWrite` у контексті worker-а, який реєструється в центральному runner'і для забезпечення можливості відкату.
