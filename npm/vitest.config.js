...
export default defineConfig({
  test: {
    ...
    // обходив би обмеження кореневого. Ключ саме `maxWorkers`: у Vitest 4
    // `poolOptions` видалено, а старий ключ мовчки ігнорується (див. розгорнутий
    // коментар і заміри у кореневому `vitest.config.mjs`).
    maxWorkers: 4,
