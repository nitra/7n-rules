...
const NETWORK_POLICY_SNIPPET_URLS = {
  deployment: new URL('../network_policy/template/deployment.snippet.yaml', import.meta.url),
  statefulSet: new URL('../network_policy/template/stateful-set.snippet.yaml', import.meta.url)
}
