...
Результат `release` — список фактично випущених workspace-ів із новими версіями; цей список далі йде в commit-back і створення анотованих тегів `\<name>@\<version>`. Якщо релізу для workspace нема, він не потрапляє до вихідного списку й не отримує тег.
