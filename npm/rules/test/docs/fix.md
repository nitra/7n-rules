...
- **Параметри:**
  - `ctx` *(опціональний)* — `RuleContext`, контекст прогону. Може містити `walkCache` та інші поля, які стандартний пайплайн використовує для оптимізацій і передачі стану між правилами в межах однієї CLI-сесії.
