...
Планування семантичних блоків може бути ініційоване з графіком, джерелами тексту та детермінованою політикою, включаючи обмеження на кількість токенів і вхідних елементів для зменшення. Планувальник створює детермінований план для оркестрації map/reduce, який є детермінованим виконанням, а не викликом LLM.

У разі неможливості планування повертається діагностичний вихід, який описує проблеми з вхідними даними або обмеженнями. Планувальник оперує вже нормалізованим графом і точними сегментами UTF-8 джерела.

Планувальник не виконує виклики LLM і не генерує документацію. Його кінцевий результат — це метадані плану для подальшої обробки.
