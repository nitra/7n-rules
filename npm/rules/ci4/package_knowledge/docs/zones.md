...
assertProtectedZonesPreserved перевіряє, чи збережено кожен існуючий захищений або ручний байт у запропонованому варіанті документа відносно попередньо зафіксованого стану.
