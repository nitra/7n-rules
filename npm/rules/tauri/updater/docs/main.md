...
7. Якщо жодного Tauri-workspace не знайдено, `lint` завершується без зауважень.
8. Під час перевірок `lint` не змінює файлову систему і не кидає помилки назовні; усі порушення повертає як звіт.
