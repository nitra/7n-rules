/**
 * Тести native-фіксу `text/vscode_settings` (§2.74, родина
 ...
 * `loadT0Patterns` віддає синтетичний native-патерн замість `fix-vscode_settings.mjs`,
...
test('домерджування у наявний конфіг: канон додано, локальне збережено', async () => {
  await withTmpDir(async dir => {
    ...
    expect(written['[vue]']['editor.defaultFormatter']).toEqual('oxc.oxc-vscode')
