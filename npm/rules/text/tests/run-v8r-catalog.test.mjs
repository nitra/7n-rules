...
describe('run-v8r', () => {
  ...
  test('runV8rWithGlobs для glob без збігів завершується 0 або 98 (без падіння)', { timeout: 20_000 }, async () => {
    const { code } = await runV8rWithGlobs(['**/this-glob-should-not-exist-xyz-12345/*.json'])
