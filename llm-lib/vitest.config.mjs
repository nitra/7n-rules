/**
 * Vitest-конфіг llm-lib: node-середовище, v8-coverage, виключення Stryker-sandbox
 * копій тестів і процесна ізоляція між тест-файлами (окремі процеси замість
 * потоків), щоб паралельна зміна робочої директорії у фікстурах не зачіпала
 * сусідні тести.
 */
import { defineConfig } from 'vitest/config'

/** Конфігурація тестового прогону llm-lib: розкладки тестів, процесна ізоляція, v8-coverage. */
