...
4. І створення session, і очікування відповіді обмежені заданим часовим лімітом. Якщо prompt перевищив ліміт, session отримує `abort`, щоб запит не лишався фоновим.
