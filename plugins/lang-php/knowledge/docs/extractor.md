...
analyzeFile повертає повний семантичний фрагмент для PHP-джерела або результат, який блокує обробку.

collectTestScenarios повертає об'єкт зі сценаріями або діагностичний об'єкт у разі відмови.

Вихід від обох функцій не гарантує відсутності помилок, але забезпечує, що процес є fail-closed.

Не відбувається самостійної обробки каталогу файлів чи аналіз імпортованих модулів.
