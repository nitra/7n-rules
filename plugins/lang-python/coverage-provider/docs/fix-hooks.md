...
Обидва потоки передають агенту корінь проєкту, список цільових файлів і ladder-контекст. Контекст використовується як спільний контракт виконання: timeout і feedback прокидаються в агентну сесію, а вибір моделі надходить із контексту або з universal policy, що поза ladder стартує від cloud-average.
