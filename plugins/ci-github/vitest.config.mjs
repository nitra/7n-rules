/**
 * Vitest-конфіг плагіна ci-github: локальний прогін лише тестів правил цього плагіна
 * з тим самим env-каноном, що й кореневий конфіг (деталі — у JSDoc до export нижче).
 */
