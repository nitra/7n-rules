...
import { eventPathsIncludeExact, parseWorkflowYaml } from '@7n/rules/scripts/lib/gha-workflow.mjs'
 ...
 * @param {import('@7n/rules/scripts/lib/lint-surface/types.mjs').LintContext} ctx detector-контекст (cwd, ruleId, concernId)
 * @returns {Promise<import('@7n/rules/scripts/lib/lint-surface/types.mjs').LintResult>} порушення concern-а
 */
