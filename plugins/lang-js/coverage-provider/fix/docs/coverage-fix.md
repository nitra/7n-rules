...
batchSurvived розкладає вцілілі мутанти з уже наявного in-memory списку по файлаx у черзі batch-ів так, щоб кожен запуск лишався в межах допустимого бюджету; надто великі source-файли не змішуються назад з іншими, щоб не породжувати oversized prompt і не розмазувати контекст по кількох сесіях.
