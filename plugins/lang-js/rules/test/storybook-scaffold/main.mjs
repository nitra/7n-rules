 ...
 * (розгалужено за {@link import('../storybook-scope/main.mjs').InScopePackage.type} — бібліотека чи
 * app, хвиля 2a) і спільний для обох типів `package.json#scripts.storybook`.
 * @param {import('../storybook-scope/main.mjs').InScopePackage} pkgEntry пакет у скоупі
 * @param {ReturnType<typeof createViolationReporter>} reporter reporter поточного лінту
 * @returns {Promise<void>}
 */
