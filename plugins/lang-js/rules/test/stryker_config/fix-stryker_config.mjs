...
import { ensureGitignoreEntries } from '@7n/rules/scripts/utils/ensure-gitignore-entries.mjs'
...
async function writeBaseline(a) {
  if (a.transform) {
    ...
    await writeFile(
      a.target,
      // eslint-disable-next-line security/detect-non-literal-regexp -- planned canonical regex replay
