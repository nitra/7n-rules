/**
 * T0-autofix концерну `npm-module/npm_package_json`: деклараційний template-deep-merge —
 * scaffold відсутнього `npm/package.json` з канонічного шаблону правила або
...
/** Фікс-патерни концерну: один template-deep-merge запис для `npm/package.json`. */
