...
name: n-fix-cursor
description: >-
  Виправити проєкт відповідно до всіх правил n cursor. Використовувати, коли користувач просить
  виправити проєкт, застосувати правила, зробити проєкт відповідним правилам, або згадує
  fix-cursor чи n-fix-cursor. Запускає діагностику, виявляє порушення, застосовує виправлення й
  перевіряє результат.
---
