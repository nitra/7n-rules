...
- **Spec-дискусія по одному питанню** зловила дві найбільші помилки самого брифу (механізму `backfill` не існує; чеки були *інвертовані*, а не лише з поганим текстом). Буквальне виконання брифу дало б невірний код.
