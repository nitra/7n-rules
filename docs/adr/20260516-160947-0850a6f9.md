...
Цей файл виглядає коректно: рядок «вмикається вручну» на рядку 32 є **лапковою цитатою** старого тексту з `adr.mdc` (описує, що _було_ замінено), а контекст на рядку 8 вже у минулому часі — «вмикалось виключно вручну». Що саме треба виправити?
