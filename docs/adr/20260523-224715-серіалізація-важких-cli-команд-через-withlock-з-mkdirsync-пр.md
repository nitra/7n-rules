...
## Context and Problem Statement
Коли агент Б намагається запустити важку команду, а лок тримає агент А, потрібно вибрати поведінку: агент Б може відмовитись, скиппропустити або чекати. Водночас, якщо стан репо не змінився, повторне виконання команди марне — результат буде ідентичним.
