...
Дата: 2026-06-14
Власник: @vitaliytv
Статус: Draft — measured ✅ (Q4 + маркова правка 2026-06-14: FP-rate `scoreDoc` **92.3% → 46.2%** після «фабрикація > мовчання»; залишок — семантичний хвіст → judge виправданий, scope `inaccurate`. Деталі в «Результати виміру»)
